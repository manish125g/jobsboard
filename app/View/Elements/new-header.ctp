            ...
            <nav class="navbar navbar-default" role="navigation" data-spy="affix" data-offset-top="50">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand logo" href="<?= $this->Html->url('/');  ?>"><?= $this->Html->image('/logo/logo.jpg', array('alt' => 'Go Tabbing', 'style'=>'width: 48px')) ?></a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="navbar">
                        ...
                        <ul class="nav navbar-nav">
                            <li>
                                <a class="" href="https://cse.google.com/cse/home?cx=008650345519931166596:ni_z2d9ca00#gsc.tab=0&gsc.sort=&gsc.ref=more%3Alinkedin" target="_blank">
                                    Search Resume
                                </a>
                            </li>
                            <li>
                                ...
                                <ul class="dropdown">
                                    <li>
                                        ...
                                        <ul class="dropdown">
                                            <?php
                                            if(!empty($this->Session->read('name')) || !empty($this->Session->read('userName'))) {
                                                ?>
