        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo $this->Form->input('News.news_title', array('type'=>'text', 'class' =>'form-control'));?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">News Short Desc</label>
                    <div class="col-sm-10">
                        <?php echo $this->Form->input('News.news_short_desc', array('type'=>'textarea', 'class' =>'form-control'));?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">News Desc</label>
                    <div class="col-sm-10">
                        <?php echo $this->Form->input('News.news_desc', array('type'=>'textarea', 'class' =>'form-control'));?>
                    </div>
                </div>
                <div class="form-group">
